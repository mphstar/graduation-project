<div onclick="handleModalQuestion()" id="bg_modal"
    class="flex duration-500 w-full h-full bg-black opacity-0 z-[120] fixed justify-center items-center pointer-events-none">
</div>

<form id="form_question" action="{{ route('student.mentoring.new_question') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div id="konten_modal"
            ...
            <header>
                <div
                    ...
                    <h1 id="titleModal" class="font-poppins-semibold">Create Question</h1>
                    <div onclick="handleModalQuestion()" class="bg-[#ED3237] py-2 flex items-center px-2 rounded-md">
            ...
            <div class="flex flex-col flex-grow w-full px-6 lg:px-12 mt-4 overflow-y-auto">
                <div class="grid grid-cols-1 h-full gap-1">
                    <div class="flex flex-col w-full">
                        ...
                        <div class="">
                            <textarea required class="w-full h-[150px] border-[2px] px-3 py-2 border-gray-300 rounded-lg" name="question" id="question"
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class=""><input required
                                ...
                                name="question_file" id="question_file" placeholder=""></div>

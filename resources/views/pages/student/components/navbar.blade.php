<div class="sticky top-0  bg-white">
    ...
    <div class="flex flex-row justify-between w-full max-w-[1280px] mx-auto px-4 py-3">
        ...
        <div id="content"
            class="md:flex translate-x-[1280px] duration-300 ease-in-out md:translate-x-0 md:h-fit flex-col md:flex-row md:border-none rounded-md w-[80%] h-screen md:w-fit px-3 fixed right-0 top-0 py-4 md:py-0 z-[100] md:static gap-2 bg-white">
            <a href="{{ route('student.profile') }}">
                <div
                    class="{{ Request::segment(2) == 'profile' ? 'flex text-white bg-red-500' : '' }} px-3 py-1 rounded-md">
                    Profile</div>
            </a>
            <a href="{{ route('student.mentoring') }}">
                <div

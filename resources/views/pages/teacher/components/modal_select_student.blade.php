<div onclick="handleSelectStudent()" id="bg_modal"
    class="flex duration-500 w-full h-full bg-black opacity-0 z-[120] fixed justify-center items-center pointer-events-none">
</div>

<form id="form_student" action="{{ route('teacher.student.set') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div id="konten_modal"
            ...
            <header>
                <div
                    ...
                    <h1 id="titleModal" class="font-poppins-semibold">Students</h1>
                    <div onclick="handleSelectStudent()" class="bg-[#ED3237] py-2 flex items-center px-2 rounded-md">
            ...
            <div class="flex flex-col flex-grow w-full px-6 lg:px-12 mt-4 overflow-y-auto">
                <div class="grid grid-cols-1 h-full gap-1">
                    <div class="flex flex-col w-full">
                        <p class="py-3">Selected Student <span class="text-red-600">*</span></p>
                        <div class="">
                            <div id="content_student"
                                class="w-full min-h-[150px] h-fit items-start border-[2px] px-3 py-2 flex flex-row flex-wrap gap-4 border-gray-300 rounded-lg">
                                <div class="flex flex-row gap-3 flex-grow w-fit items-center">
                                    <input type="checkbox" name="" id="">
                                    <label for="">Bintang Malindo</label>
                                </div>
                                <div class="flex flex-row gap-3 flex-grow w-fit items-center">
                                    <input type="checkbox" name="" id="">
                                    <label for="">Bintang Malindo</label>
                    ...
                    <div class="flex flex-col w-full">
                        <p class="py-3">Unselected Student <span class="text-red-600">*</span></p>
                        <div class="">
                            <div id="unselected_content_student"
                                class="w-full min-h-[150px] h-fit items-start border-[2px] px-3 py-2 flex flex-row flex-wrap gap-4 border-gray-300 rounded-lg">
                                <div class="flex flex-row gap-3 flex-grow w-fit items-center">
                                    <input type="checkbox" name="" id="">
                                    <label for="">Bintang Malindo</label>

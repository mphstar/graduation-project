                ...
                <table class="border-separate border-spacing-y-3">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-4 text-left">First Name</th>
                            <th class="px-4 py-4 text-left">Last Name</th>
                            <th class="px-4 py-4 text-left">Student ID Number</th>
                            <th class="px-4 py-4 text-left">Major</th>
                        </tr>
                    </thead>
                    <tbody class="bg-gray-100 rounded-xl">
                        @if (count($student) == 0)
                            <td class="text-center px-4 py-2" colspan="5">No Data</td>
                        @endif
                        <form class="" id="form_delete" action="" method="post">
                            ...
                            @foreach ($student as $item)
                                <tr class="" style="opacity: 1; transform: none;">
                                    ...
                                    <td class="text-left px-4 py-3">{{ $item->major ? $item->major->name : '-' }}</td>
...
@section('otherjs')
    <script src="/js/teacher/student.js"></script>
